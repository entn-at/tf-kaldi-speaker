...
num_pdfs=         # It is a pre-determined parameter
...
for f in $data/feats.scp $alidir/monophone.scp $alidir/tree ; do
...
feats="ark,s,cs:utils/filter_scp.pl --exclude $dir/valid_uttlist $sdata/JOB/feats.scp | apply-cmvn-sliding --center=true scp:- ark:- |"
...
if [ $stage -le 3 ]; then
  ...
  utils/filter_scp.pl <(cat $dir/valid_uttlist $dir/train_subset_uttlist) \
    < $alidir/monophone.scp > $dir/ali_special.scp
...
if [ $stage -le 4 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/get_egs.JOB.log \
    ...
    "ark,s,cs:filter_scp.pl $sdata/JOB/utt2spk $alidir/monophone.scp | ali-to-post scp:- ark:- |" ark:- \| \
